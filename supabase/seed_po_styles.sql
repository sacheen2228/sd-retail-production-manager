...
from (values
  ('BR-001', 'Lehenga Set', 'Bridal', 'Lehenga Set', 'Red', 'M', 6, 18000, 'Banarasi Silk', 'Zari Border (gold)', 'Stitching', '2026-07-25', 0, 'PO-2026-001'),
  ('BR-002', 'Gown', 'Bridal', 'Gown', 'Ivory', 'M', 3, 24000, 'Raw Silk Dupion', 'Pearl Buttons', 'Embroidery-Mumbai', '2026-07-18', 0, 'PO-2026-001'),
  ('BR-003', 'Anarkali', 'Bridal', 'Anarkali', 'Gold', 'Free', 4, 12000, 'Organza', 'Zari Border (gold)', 'Fabric', '2026-07-28', 0, 'PO-2026-001'),
  ('OC-101', 'Suit', 'Occasions', 'Suit', 'Navy', 'XL', 8, 6500, 'Organza', 'Pearl Buttons', 'Cutting', '2026-07-22', 0, 'PO-2026-002'),
  ('OC-102', 'Kurta Set', 'Occasions', 'Kurta Set', 'Pastel Pink', 'M', 10, 4800, 'Raw Silk Dupion', 'Pearl Buttons', 'Sampling', '2026-07-30', 0, 'PO-2026-002'),
  ('OC-103', 'Anarkali', 'Occasions', 'Anarkali', 'Emerald', 'M', 5, 7500, 'Banarasi Silk', 'Zari Border (gold)', 'Embroidery-Kolkata', '2026-07-12', 0, 'PO-2026-002'),
  ('CT-201', 'Gown', 'Cocktail Wear', 'Gown', 'Black', 'L', 4, 9500, 'Organza', 'Zari Border (gold)', 'QC', '2026-07-10', 0, 'PO-2026-003'),
  ('CT-202', 'Sharara Set', 'Cocktail Wear', 'Sharara Set', 'Teal', 'M', 6, 8000, 'Raw Silk Dupion', 'Pearl Buttons', 'Stitching', '2026-07-15', 0, 'PO-2026-003'),
  ('RK-301', 'Suit', 'Menswear', 'Suit', 'Navy', 'L', 5, 9000, 'Banarasi Silk', 'Pearl Buttons', 'Dispatched', '2026-06-20', 5, 'PO-2026-004'),
  ('RK-302', 'Bandhgala', 'Menswear', 'Bandhgala', 'Black', 'M', 4, 14000, 'Raw Silk Dupion', 'Zari Border (gold)', 'Dispatched', '2026-06-25', 4, 'PO-2026-004'),
  ('OC-301', 'Lehenga Set', 'Bridal', 'Lehenga Set', 'Red', 'Free', 5, 16000, 'Banarasi Silk', 'Zari Border (gold)', 'Sampling', '2026-07-29', 0, 'PO-2026-005'),
  ('OC-302', 'Suit', 'Occasions', 'Suit', 'Gold', 'M', 7, 7000, 'Organza', 'Pearl Buttons', 'Sampling', '2026-07-29', 0, 'PO-2026-005')
