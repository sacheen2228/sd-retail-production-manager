...
- **Stock Report** — **ready-stock inventory of finished garments** by category/sub-category (Lehenga Set, Suit, Anarkali, Set-2, Set-3, Gown, Kurta Set, Bandhgala…). Shows pieces on hand, cost/selling price, stock value, low/out-of-stock status, with **+ Stock** quick-add and full item add/edit, filters and CSV export. (Fabric & trim allocation is available under **Partners & Stock → Fabric Stock Report**.)
